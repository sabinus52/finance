...
final class Version20221106154742 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stock_portfolio (id INT AUTO_INCREMENT NOT NULL, stock_id INT NOT NULL, account_id INT NOT NULL, date DATE NOT NULL, position SMALLINT NOT NULL, volume DOUBLE PRECISION DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, fee DOUBLE PRECISION DEFAULT NULL, total DOUBLE PRECISION NOT NULL, INDEX IDX_A9ED1062DCD6110 (stock_id), INDEX IDX_A9ED10629B6B5FBA (account_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

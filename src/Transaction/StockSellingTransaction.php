 ...
 */
final class StockSellingTransaction extends TransactionModelAbstract implements TransactionModelInterface
{
    ...
    {
        return new StockPosition(StockPosition::SELLING);
    }
